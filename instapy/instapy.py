...
class InstaPy:
    ...
    def __init__(
        ...
        self.comments = ["Complimenti, belle foto", "Complimenti!", "Bella foto!", "Belle foto!", "Complimenti per le foto", "Foto stupende", "Bel profilo instagram", "Stupende queste foto", "Che belle queste foto!", "Che foto!" ]
        self.photo_comments = []
        self.video_comments = []
